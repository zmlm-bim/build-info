<template lang="html">
  <div class="cron" :val="value_">
       <Tabs type="card">
        <Tab-pane label="秒">SecondAndMinute</Tab-pane>
        <Tab-pane label="分">SecondAndMinute</Tab-pane>
        <Tab-pane label="时">hour</Tab-pane>
                <Tab-pane label="日">day</Tab-pane>
        <Tab-pane label="月">标签二的内容</Tab-pane>
        <Tab-pane label="周">标签三的内容</Tab-pane>
                <Tab-pane label="秒">标签一的内容</Tab-pane>
        <Tab-pane label="分">标签二的内容</Tab-pane>
        <Tab-pane label="年">标签三的内容</Tab-pane>
    </Tabs>
