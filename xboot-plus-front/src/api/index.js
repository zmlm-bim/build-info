...
// 分页获取数据
export const getProjecInfo = (params) => {
    return getRequest('/projectInfo/getByCondition', params)
}
// 添加
export const addProjecInfo = (params) => {
    return postRequest('/projectInfo/save', params)
}
// 编辑
export const editProjecInfo = (params) => {
    return putRequest('/projectInfo/update', params)
}
// 删除
