...
export const getProjectList = (params) => {
    return getRequest('/your/projectList/getByCondition', params)
}
// 添加
export const addProjectList = (params) => {
    return postRequest('/your/projectList/save', params)
}
// 编辑
export const editProjectList = (params) => {
    return putRequest('/your/projectList/update', params)
}
// 删除
export const deleteProjectList = (params) => {
    return postRequest('/your/projectList/delByIds', params)
}
